...
public class RichTextUnsuperscriptTag : RichTextTag {
    private static readonly RichTextLayout[] LAYOUTS = [new(0, LayoutType.FontSize, 1 / 0.75f), new(0, LayoutType.VerticalOffset, -0.25f)];
